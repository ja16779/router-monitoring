...
WAN="lan1"  # Example: eth0, eth0.2, eth1, eth1.2, wan, etc.
...
BANDWIDTH_DOWN="110"  # Change this to about 80-95% of your download speed (in megabits).
BANDWIDTH_UP="110"     # Change this to about 80-95% of your upload speed (in megabits).
...
[ "$ACTION" = ifup ] || exit 0
[ "$INTERFACE" = wan ] || [ "$INTERFACE" = IOT ] || exit 0
