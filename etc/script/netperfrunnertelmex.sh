...
do
	netperf $TESTPROTO -L 192.168.1.1 -H $TESTHOST -t TCP_STREAM -l $TESTDUR -v 0 -P 0 >> $ULFILE &
...
for i in $( seq $MAXSESSIONS )
do
	netperf $TESTPROTO -L 192.168.1.1 -H $TESTHOST -t TCP_MAERTS -l $TESTDUR -v 0 -P 0 >> $DLFILE &
